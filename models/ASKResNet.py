...
class S3KAIResNet(nn.Module):
    def __init__(self, band, classes, reduction,PARAM_KERNEL_SIZE=24):
...
def ASKResNet(n_bands, num_classes):
    model = S3KAIResNet(n_bands, num_classes, 2)
    return model