...
def RSSAN(n_bands, num_classes):
    # out_chanel = 'IP、SA:32 PU:8 '
    model = RSSAN_network(num_classes, n_bands, 3, out_chanel = 8, stride=1, padding=1, windows=17)
    return model