...
class SSNet_IA(nn.Module):
    def __init__(self, num_classes, bands, msize=16, inter_size=49):
        super(SSNet_IA, self).__init__()
...
class SSNet_PU(nn.Module):
    def __init__(self, num_classes, bands, msize=18, inter_size=49):
        super(SSNet_PU, self).__init__()
...
class SSNet_SA(nn.Module):
    def __init__(self, num_classes, bands, msize=13, inter_size=99, l1='SA'):
        super(SSNet_SA, self).__init__()
...
def SSTN(dataset, bands, classes):
    if dataset == 'PaviaU':
        model = SSNet_PU(classes, bands)
    elif dataset == 'Salinas':
        model = SSNet_SA(classes, bands)
    else:
        model = SSNet_IA(classes, bands)
    return model
